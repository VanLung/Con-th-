...
import phucnt.tblUsers.UserDTO;
...
public class CheckOutServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            List<ProductDTO> result = (List<ProductDTO>) request.getAttribute("CHECKOUT_CART");
            ...
            if (cart != null) {
                ...
                for (String item : cart.getItems().keySet()) {
                    ...
                    ProductDTO dto = dao.getProductInfo(productID, quantity);                    
                    if(dto != null){
                        result.add(dto);
                    }
                }
            }
            request.setAttribute("CHECKOUT_CART", result);
